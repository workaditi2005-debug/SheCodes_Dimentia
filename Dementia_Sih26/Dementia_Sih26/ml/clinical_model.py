...
class ClinicalReferencePipeline:
    """Mock/wrapper pipeline representing trained OASIS LogisticRegression estimator."""
...
def _get_metadata_path() -> str:
    return os.path.join(os.path.dirname(__file__), "artifacts", "clinical_model_metadata.json")
